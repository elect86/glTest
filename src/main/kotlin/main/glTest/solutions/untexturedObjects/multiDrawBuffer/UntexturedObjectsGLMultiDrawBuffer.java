...
public class UntexturedObjectsGLMultiDrawBuffer extends UntexturedObjectsSolution {
    ...
    public UntexturedObjectsGLMultiDrawBuffer(boolean useShaderDrawParameters) {
        ...
        setUpdateFps(useShaderDrawParameters ? 60 : 130);
    }
    ...
    public boolean init(GL4 gl4, ByteBuffer vertices, ByteBuffer indices, int objectCount) {
        ...
        commands = GLBuffers.newDirectByteBuffer(DrawElementsIndirectCommand.Companion.getSIZE() * objectCount);
    ...
    public void render(GL4 gl4, ByteBuffer transforms) {
        ...
        for (int u = 0; u < count; u++) {
            ...
            commands.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_COUNT(), indexCount);
            commands.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_INSTANCE_COUNT(), 1);
            commands.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_FIRST_INDEX(), 0);
            commands.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_BASE_VERTEX(), 0);
            commands.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_BASE_INSTANCE(), useShaderDrawParameters ? 0 : u);
        }
