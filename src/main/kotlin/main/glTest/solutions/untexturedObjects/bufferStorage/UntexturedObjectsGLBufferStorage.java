...
public class UntexturedObjectsGLBufferStorage extends UntexturedObjectsSolution {
    ...
    public UntexturedObjectsGLBufferStorage(boolean useShaderDrawParameters) {
        ...
        setUpdateFps(useShaderDrawParameters ? 70 : 200);
    }
    ...
    public boolean init(GL4 gl4, ByteBuffer vertices, ByteBuffer indices, int objectCount) {
        ...
        commandBuffer = GLBuffers.newDirectByteBuffer(DrawElementsIndirectCommand.Companion.getSIZE() * objectCount);
    ...
    public void render(GL4 gl4, ByteBuffer transforms) {
        ...
        for (int u = 0; u < objectCount; u++) {
            ...
            int offset = u * DrawElementsIndirectCommand.Companion.getSIZE();
            commandBuffer.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_COUNT(), indexCount);
            commandBuffer.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_INSTANCE_COUNT(), 1);
            commandBuffer.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_FIRST_INDEX(), 0);
            commandBuffer.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_BASE_VERTEX(), 0);
            commandBuffer.putInt(offset + DrawElementsIndirectCommand.Companion.getOFFSET_BASE_INSTANCE(), useShaderDrawParameters ? 0 : u);
        }
