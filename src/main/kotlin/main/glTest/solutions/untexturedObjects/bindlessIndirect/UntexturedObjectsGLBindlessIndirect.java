...
public class UntexturedObjectsGLBindlessIndirect extends UntexturedObjectsSolution {
    ...
    public void render(GL4 gl4, ByteBuffer transforms) {
        ...
        for (int i = 0; i < objectCount; i++) {
            ...
            commands.putInt(Command.SIZE * i + Command.OFFSET_DRAW + DrawElementsIndirectCommand.Companion.getOFFSET_COUNT(), indexCount);
            commands.putInt(Command.SIZE * i + Command.OFFSET_DRAW + DrawElementsIndirectCommand.Companion.getOFFSET_INSTANCE_COUNT(), 1);
            commands.putInt(Command.SIZE * i + Command.OFFSET_DRAW + DrawElementsIndirectCommand.Companion.getOFFSET_FIRST_INDEX(), 0);
            commands.putInt(Command.SIZE * i + Command.OFFSET_DRAW + DrawElementsIndirectCommand.Companion.getOFFSET_BASE_VERTEX(), 0);
            commands.putInt(Command.SIZE * i + Command.OFFSET_DRAW + DrawElementsIndirectCommand.Companion.getOFFSET_BASE_INSTANCE(), 0);
